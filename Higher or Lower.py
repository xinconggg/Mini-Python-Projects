...
def comparison_data(right_answer):
    if right_answer == 0:
...
def play_game():
    ...
    while not game_over:
        compare_A, compare_B = comparison_data(right_answer)
        print(f"Compare A: {compare_A['name']}, a {compare_A['description']}, from {compare_A['country']}.")
        print(vs)
        print(f"Against B: {compare_B['name']}, a {compare_B['description']}, from {compare_B['country']}.")

        no_of_followers_A = int(compare_A['follower_count'])
        no_of_followers_B = int(compare_B['follower_count'])
